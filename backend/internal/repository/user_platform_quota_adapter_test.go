...
func (f *fakeRepoForAdapter) IncrementUsageWithReset(_ context.Context, _ int64, _ string, _ float64, _ time.Time, _ map[string]service.ResolvedQuotaWindow) error {
	return nil
}
